...
extern void basicSgemm( char transa, char transb, int m, int n, int k, float alpha, const float *A, int lda, const float *B, int ldb, float beta, float *C, int ldc , int logical_streams, int task_blocks);
...
main (int argc, char *argv[]) {
  ...
  basicSgemm('N', 'T', matArow, matBcol, matAcol, 1.0f,
      ...
      matArow, logical_streams, task_blocks);
